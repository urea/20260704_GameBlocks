  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        snakeGarden: path.resolve(projectRoot, "experiments/snake-garden/index.html"),
        circuitDash: path.resolve(projectRoot, "experiments/circuit-dash/index.html"),
        hoverSalvage: path.resolve(projectRoot, "experiments/hover-salvage/index.html"),
        turretRange: path.resolve(projectRoot, "experiments/turret-range/index.html"),
      },
    },
  },
});
